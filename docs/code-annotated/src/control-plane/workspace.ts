/**
 * [control-plane/workspace] - 工作区管理服务
 * 功能概述：工作区的创建、列表、切换、删除、同步等完整生命周期管理
 * 核心导出：Service, layer, Event
 * 架构位置：service layer，依赖 schema、types、adapters、workspace.sql、project、sync、session 等模块
 */
