/**
 * [control-plane/types] - 控制面类型定义
 * 功能概述：定义 WorkspaceInfo、WorkspaceAdapterEntry、WorkspaceAdapter 接口和工作区目标类型
 * 核心导出：WorkspaceInfo, WorkspaceAdapterEntry, WorkspaceAdapter, Target
 * 架构位置：type definitions layer，被 workspace、adapters、workspace-adapter-runtime 依赖
 */
