/**
 * [format/formatter] - 格式化器定义
 * 功能概述：定义各种代码格式化器（gofmt、prettier、rustfmt、black 等）的元数据和启用条件
 * 核心导出：gofmt, prettier, Info, Context
 * 架构位置：definition layer，被 format/index.ts 依赖
 */
