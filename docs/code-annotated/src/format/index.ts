/**
 * [format/index] - 代码格式化服务
 * 功能概述：提供代码格式化服务，包括格式化器初始化、状态查询、文件格式化，管理子进程调用
 * 核心导出：Service, layer, Status
 * 架构位置：service layer，依赖 formatter 定义、Config、InstanceState、Process
 */
