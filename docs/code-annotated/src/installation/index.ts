/**
 * [installation/index] - 安装管理服务
 * 功能概述：管理 OpenCode 安装生命周期（更新检查、自动更新、版本检测、安装方法识别）
 * 核心导出：Service, layer, Method, ReleaseType
 * 架构位置：service layer，依赖 auth、bus-event、@opencode-ai/core 等模块
 */
