/**
 * project/project - 项目管理服务：项目的增删改查与元数据管理
 *
 * 功能概述：
 * - 创建、查询、更新、删除项目
 * - 管理项目沙箱（sandbox）配置
 ...
 *
 * 核心导出：
 * - Service：项目管理服务 Context 类
 * - layer：项目管理 Effect Layer
 *
 * 架构位置：Project 模块服务层，是 opencode 项目管理的核心入口。
 * 上游依赖：project/project.sql（数据库表）、project/schema（项目 ID Schema）
 */
