/**
 * [image/image] - 图片处理服务
 * 功能概述：图片压缩、尺寸调整、Base64 编码转换，使用 photon-wasm 进行高性能图片处理
 * 核心导出：Service, layer, ResizerUnavailableError
 * 架构位置：service layer，依赖 photon-wasm、Config、session/message-v2
 */
