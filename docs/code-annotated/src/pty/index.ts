/**
 * pty/index - PTY 服务层：管理伪终端（Pseudo Terminal）的创建和交互
 *
 * 功能概述：
 * - 创建和管理 PTY 进程
 * - 处理 PTY 输入输出
 ...
 *
 * 核心导出：
 * - Service：PTY 服务 Context 类
 * - layer：PTY 服务 Effect Layer
 *
 * 架构位置：PTY 模块服务层，是 opencode 终端功能的核心。
 * 上游依赖：pty/schema（PTY ID）、pty/pty（PTY 类型定义）
 */
