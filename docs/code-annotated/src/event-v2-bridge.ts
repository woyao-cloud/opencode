/**
 * [event-v2-bridge] - 事件 V2 桥接层
 * 功能概述：将核心 EventV2 发布路径桥接到传统 bus/sync 事件负载，供旧版消费者和 HTTP 事件流使用
 * 核心导出：Service, layer, toSyncDefinition
 * 架构位置：bridge layer，连接 EventV2 核心系统与 SyncEvent/GlobalBus 旧系统
 */
