/**
 * [account/account] - Account 业务逻辑层
 * 功能概述：OAuth 设备码登录流程、账户信息获取、Token 刷新、HTTP 通信与缓存
 * 核心导出：Service, layer, Event, AuthError
 * 架构位置：service layer，依赖 repo、schema、url，提供账户服务给上层模块
 */
