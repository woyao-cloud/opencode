/**
 * [account/repo] - Account 数据仓库层
 * 功能概述：账户 CRUD 操作（激活、列表、删除、Token 持久化、账户信息持久化）
 * 核心导出：AccountRepo, Interface, AccountRow
 * 架构位置：repository layer，依赖 account.sql 数据表和 schema 类型
 */
