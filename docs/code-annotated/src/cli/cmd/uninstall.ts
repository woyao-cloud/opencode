/**
 * cli/cmd/uninstall - "opencode uninstall" 命令
 *
 * 功能概述：
 * - 实现 uninstall 命令，卸载 opencode
 * - 支持 --keep-config、--keep-data、--dry-run 等选项
 *
 * 核心导出：
 * - UninstallCommand: yargs CommandModule 对象
 *
 * 架构位置：CLI 命令层，被 cli/cmd/ 索引注册，依赖 installation 模块和 clack/prompts
 */
