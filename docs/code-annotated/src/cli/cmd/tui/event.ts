/**
 * cli/cmd/tui/event - TUI 事件定义
 *
 * 功能概述：
 * - 基于 BusEvent 定义 TUI 模块内所有事件类型
 * - 涵盖 PromptAppend、CommandExecute、ToastShow、SessionListChange 等
 *
 * 核心导出：
 * - TuiEvent: 包含 PromptAppend、CommandExecute、ToastShow 等事件定义的对象
 *
 * 架构位置：TUI 事件层，被 TUI 内各组件/上下文用于发布和订阅事件
 */
