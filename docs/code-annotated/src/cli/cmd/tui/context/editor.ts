/**
 * cli/cmd/tui/context/editor - 编辑器上下文
 *
 * 功能概述：
 * - 管理编辑器集成，支持 VS Code、Zed 等编辑器的文件跳转
 * - 提供 EditorSelection 类型和创建/打开文件的上下文
 *
 * 核心导出：
 * - EditorContextProvider / useEditorContext: 编辑器上下文提供者与 Hook
 *
 * 架构位置：TUI 上下文层，被多个组件用于文件跳转操作
 */
