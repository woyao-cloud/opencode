/**
 * cli/cmd/tui/context/command-palette - 命令面板上下文
 *
 * 功能概述：
 * - 提供 TUI 命令面板（Command Palette）的上下文和交互逻辑
 * - 支持模糊搜索命令、快捷键绑定和选择执行
 *
 * 核心导出：
 * - CommandPaletteProvider / useCommandPalette: 命令面板上下文提供者与 Hook
 *
 * 架构位置：TUI 上下文层，被 app.tsx 和 TUI 路由页面引用
 */
