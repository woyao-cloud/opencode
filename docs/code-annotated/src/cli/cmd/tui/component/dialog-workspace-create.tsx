/**
 * cli/cmd/tui/component/dialog-workspace-create - 工作区创建/选择对话框
 *
 * 功能概述：
 * - 提供 TUI 工作区创建和选择对话框组件
 * - 支持最近工作区列表、工作区切换和文件变更确认
 *
 * 核心导出：
 * - DialogWorkspaceSelect: SolidJS 工作区选择对话框组件
 * - openWorkspaceSelect: 打开工作区选择
 * - warpWorkspaceSession: 切换工作区会话
 *
 * 架构位置：TUI 组件
 */
