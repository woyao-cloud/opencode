/**
 * cli/cmd/tui/component/dialog-workspace-file-changes - 工作区文件变更确认对话框
 *
 * 功能概述：
 * - 提供 TUI 工作区文件变更确认对话框组件
 * - 显示 VCS 文件变更状态并允许用户确认是否继续
 *
 * 核心导出：
 * - DialogWorkspaceFileChanges: SolidJS 文件变更确认对话框组件
 *
 * 架构位置：TUI 组件
 */
