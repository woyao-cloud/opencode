/**
 * cli/cmd/tui/component/dialog-provider - 提供商配置对话框
 *
 * 功能概述：
 * - 提供 TUI AI 提供商选择与配置对话框组件
 * - 支持 API Key 设置、认证方式选择和模型选择
 *
 * 核心导出：
 * - DialogProvider: SolidJS 提供商配置对话框组件
 * - providerOptions: 提供商列表格式化工具函数
 * - createDialogProviderOptions: 创建提供商选项列表
 *
 * 架构位置：TUI 组件
 */
