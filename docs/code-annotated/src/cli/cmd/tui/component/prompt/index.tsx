/**
 * cli/cmd/tui/component/prompt/index - 提示输入主组件
 *
 * 功能概述：
 * - TUI 提示输入框主组件，包含文本编辑、自动补全、历史记录等功能
 * - 支持粘贴事件、键盘导航和鼠标交互
 *
 * 核心导出：
 * - PromptInput: SolidJS 提示输入框组件
 *
 * 架构位置：TUI 组件层，被 TUI 路由页面引用，组合 autocomplete / history / stash 等子模块
 */
