/**
 * cli/cmd/tui/component/prompt/history - 提示历史管理
 *
 * 功能概述：
 * - 管理提示输入历史记录，包括持久化存储和检索
 * - 支持 TextPart / FilePart / AgentPart 等多种部件类型
 *
 * 核心导出：
 * - PromptInfo 类型及相关历史管理函数
 *
 * 架构位置：TUI 组件层，被 prompt/index.tsx 引用
 */
