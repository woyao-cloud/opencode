/**
 * cli/cmd/github - "opencode github" 命令
 *
 * 功能概述：
 * - 实现 github 命令，与 GitHub Actions / Issues / PRs 集成
 * - 支持 issue-comment、pull-request-review-comment 等事件处理
 *
 * 核心导出：
 * - GithubCommand: yargs CommandModule
 *
 * 架构位置：CLI 命令层，被 cli/cmd/ 索引注册，依赖 @octokit 和 @actions/github SDK
 */
