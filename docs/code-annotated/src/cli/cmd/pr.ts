/**
 * cli/cmd/pr - "opencode pr" 命令
 *
 * 功能概述：
 * - 实现 pr 命令，获取并检出 GitHub PR 分支后运行 opencode
 *
 * 核心导出：
 * - PrCommand: 使用 effectCmd 封装的 yargs 命令定义
 *
 * 架构位置：CLI 命令层，被 cli/cmd/ 索引注册，依赖 git 模块和 process 模块
 */
