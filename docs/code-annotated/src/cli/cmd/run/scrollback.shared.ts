/**
 * cli/cmd/run/scrollback.shared.ts - Scrollback 渲染样式共享层
 *
 * 功能概述：
 * - 提供 scrollback 条目的颜色、语法高亮、外观样式的纯函数
 * - 从 RunTheme 和 StreamCommit 派生具体的渲染属性
 *
 * 核心导出：
 * - entryColor: 条目颜色
 * - entrySyntax: 条目语法样式
 ...
 * 被 scrollback.writer.tsx 用于条目的视觉渲染
 */
