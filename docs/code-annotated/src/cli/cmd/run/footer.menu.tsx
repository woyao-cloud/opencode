/**
 * cli/cmd/run/footer.menu.tsx - Footer 菜单面板组件
 *
 * 功能概述：
 * - 渲染 footer 中的菜单/选择面板 UI
 * - 支持键盘导航：上下键选择、回车确认
 * - 提供创建菜单状态和渲染菜单项的工具
 *
 * 核心导出：
 * - RunFooterMenu: 菜单 UI 组件
 * - createFooterMenuState: 创建菜单状态
 * - RunFooterMenuItem: 菜单项类型
 * - FOOTER_MENU_ROWS: 菜单行数常量
 *
 * 架构位置：CLI run 命令子模块 footer 区域，
 * 被 footer.view 用于展示命令/模型/变体选择菜单
 */
